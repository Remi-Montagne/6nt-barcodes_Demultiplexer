...
public:
    // Constructor
    Barcode(string bcName, string bcSeq) : m_bcName(bcName), m_bcSeq(bcSeq) {}
...
public:
    // Constructor
    Demultiplexer(string inFile1, string inFile2, vector<Barcode> &barcodes) : m_inFile1(inFile1), m_inFile2(inFile2), m_barcodes(barcodes)
    {
